...
banner_text: "A simple CSS trick to set the max-width of component such that content is centered and in-focus on any viewport. The same logic can also applied to other quantities like height, font size, etc."
---
